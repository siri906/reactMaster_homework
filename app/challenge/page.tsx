  ...
  return (
    <div className="cont">
      <div className="first">
        ...
        <ul className="list_weather">
          <li className="bg-white">
            <div className="left_area">
              <strong>Casius</strong>
              <p>Mars, 12AM</p>
            </div>
          ...
          <li className="bg-orange-600 text-white">
            <div className="left_area">
              <strong>Casius</strong>
              <p>Mars, 12AM</p>
            </div>
        ...
        <div className="plus_area">
          <button className="circle_button">+</button>
        </div>
      </div>
      <div className="second">
        <div className="t_area">
          <button className="circle_button">X</button>
        </div>
        ...
        <div className="tag_area">
          <ul className="list_tag">
            <li className="bg-yellow-400">
              <div className="bx_svg">
                <svg data-slot="icon" fill="none" stroke-width="1" stroke="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z"></path>
                </svg>
              </div>
            </li>
            <li className="bg-emerald-400">
              <div className="bx_svg">
                <svg data-slot="icon" fill="none" stroke-width="1" stroke="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z"></path>
                </svg>
        ...
        <div className="btn_area">
          <button>Let&apos;s get it done</button>
        </div>
      </div>
      <div className="third">
        <div className="t_area">
        ...
        <div className="search_area">
          <div className="ipt_area">
            <input type="text" placeholder="Search with love..." />
            <button>
